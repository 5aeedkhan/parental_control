          ...
          Row(
            children: [
              ...
              Expanded(
                child: Column(
                  children: [
                    _buildLegendItem('Games', AppColors.gamesColor, 45),
                    const SizedBox(height: 8),
                    _buildLegendItem('Social', AppColors.socialColor, 25),
                    const SizedBox(height: 8),
                    _buildLegendItem('Education', AppColors.educationColor, 20),
                    const SizedBox(height: 8),
                    _buildLegendItem('Other', AppColors.otherColor, 10),
                  ],
                ),
              ),
            ],
